...
const Navbar = () => {
  ...
  const mobileNavLinkStyle = (path) =>
    `block py-3 px-4 text-lg text-gray-300 hover:text-white hover:bg-white/10 rounded-lg transition-all ${
      isActive(path) ? "font-semibold bg-white/5" : ""
    }`;
      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            <Link href="/features" className={navLinkStyle('/features')}>
            ...
            <Link href="/how-it-works" className={navLinkStyle('/how-it-works')}>
              <motion.span whileHover={{ y: -2 }} className="block">
                How It Works
              </motion.span>
          ...
          {isMobileMenuOpen && (
            ...
            >
              <div className="flex flex-col space-y-2 p-2">
                <Link
                  href="/features"
                  className={mobileNavLinkStyle('/features')}
                ...
                <Link
                  href="/how-it-works"
                  className={mobileNavLinkStyle('/how-it-works')}
                  onClick={closeMobileMenu}
                >
                  How It Works
                </Link>
                <Link
                  href="/about"
                  className={mobileNavLinkStyle('/about')}
                  onClick={closeMobileMenu}
                >
                  About
                </Link>
                <Link
                  href="/contact"
                  className={mobileNavLinkStyle('/contact')}
                  onClick={closeMobileMenu}
                >
                  Contact
                </Link>
